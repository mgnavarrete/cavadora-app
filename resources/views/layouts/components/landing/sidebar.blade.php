                    ...
                    <div class="main-sidebar">
                        ...
                        <nav class="main-menu-container nav nav-pills sub-open">
                            <div class="landing-logo-container">
                                <div class="horizontal-logo">
                                    <a href="{{url('/')}}" class="header-logo">
                                        <img src="{{asset('build/assets/images/brand-logos/desktop-logo.png')}}" alt="La Cavadora" class="desktop-logo">
                                        <img src="{{asset('build/assets/images/brand-logos/desktop-white.png')}}" alt="La Cavadora" class="desktop-white">
                                    </a>
                                </div>
                            </div>
                            ...
                            <ul class="main-menu">
                                ...
                                <!-- Start::slide -->
                                <li class="slide">
                                    <a href="#proceso" class="side-menu__item">
                                ...
                                <!-- Start::slide -->
                                <li class="slide">
                                    <a href="#quienes-somos" class="side-menu__item">
