                                ...
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                                    <div class="card custom-card text-center h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-3">info@lacavadora.cl</p>
                                            <a href="mailto:info@lacavadora.cl" class="btn btn-outline-light btn-sm">Enviar email</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="px-4">
                                        ...
                                        <ul class="list-unstyled fw-normal landing-footer-list">
                                            ...
                                            <li>
                                                <a href="info@lacavadora.cl" class="text-fixed-white op-6"><i class="ri-mail-line me-1 align-middle"></i> info@lacavadora.cl</a>
                                            </li>
                                            <li>
