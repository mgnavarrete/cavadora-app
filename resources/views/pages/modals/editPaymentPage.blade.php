    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('payments.updateStatus', $payment->id_payment) }}" method="POST" class="form-edit-payment" data-form-id="{{ $payment->id_payment }}">
          ...
          <div class="row mb-3">
            <div class="col-12">
              <label for="description{{ $payment->id_payment }}" class="form-label fw-semibold">
                <i class="ri-file-text-line me-1"></i>Notas / Observaciones
              </label>
              <textarea class="form-control" id="description{{ $payment->id_payment }}" name="description" rows="4" 
